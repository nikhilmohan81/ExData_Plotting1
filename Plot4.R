...
# make the plot region into 2 by 2. make sure the margins are set
par(mfrow=c(2,2), mar = c(4,4,1,1))

# plot 1
with(inputfile_1, plot(Datetime, Global_active_power, type = "l", ylab = "Global Active Power", xlab = " "))

# plot 2
with(inputfile_1, plot(Datetime, Voltage, type = "l", ylab = "Voltage", xlab = "datetime"))
...
# plot 4
with(inputfile_1, plot(Datetime, Global_reactive_power, type = "l", ylab = "Global_reactive_power", xlab = "datetime"))

dev.copy(png, filename = "./plot4.png", width = 780)
